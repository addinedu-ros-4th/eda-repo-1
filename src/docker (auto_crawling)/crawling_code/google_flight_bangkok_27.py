...
def get_osaka_data():
    ...
    date_ui_inside.send_keys("20240127")
    driver.implicitly_wait(5)
...
def main():
    ...
    if not os.path.exists("/app/data"):
        df.to_csv("/app/data/google_bangkok_27.csv", index=False, mode = "w", encoding="utf-8")
    else :
        df.to_csv("/app/data/google_bangkok_27.csv", index=False, mode = "a", encoding="utf-8", header=False)
