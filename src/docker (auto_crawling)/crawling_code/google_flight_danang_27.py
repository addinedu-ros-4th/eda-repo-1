...
def get_osaka_data():
    ...
    time.sleep(2)
    arrival_text_input[0].send_keys("DAD")
    driver.implicitly_wait(5)
...
def main():
    ...
    if not os.path.exists("/app/data"):
        df.to_csv("/app/data/google_danang_27.csv", index=False, mode = "w", encoding="utf-8")
    else :
        df.to_csv("/app/data/google_danang_27.csv", index=False, mode = "a", encoding="utf-8", header=False)
