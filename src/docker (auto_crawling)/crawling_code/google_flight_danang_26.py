...
def main():
    ...
    if not os.path.exists("/app/data"):
        df.to_csv("/app/data/google_danang_26.csv", index=False, mode = "w", encoding="utf-8")
    else :
        df.to_csv("/app/data/google_danang_26.csv", index=False, mode = "a", encoding="utf-8", header=False)
